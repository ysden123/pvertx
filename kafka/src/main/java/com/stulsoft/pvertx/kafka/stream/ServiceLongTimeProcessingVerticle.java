 ...
 * @author Yuriy Stul
 */
public class ServiceLongTimeProcessingVerticle extends AbstractVerticle {
    private static final Logger logger = LoggerFactory.getLogger(ServiceLongTimeProcessingVerticle.class);
    ...
    private void handler(Message<String> msg) {
        ...
        vertx.setTimer(25000 + random.nextInt(1000),
                l -> {

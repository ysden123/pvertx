 ...
 * @author Yuriy Stul
 */
public class AsyncTestEx02 extends AbstractVerticle {
    private static final Logger logger = LoggerFactory.getLogger(AsyncTestEx02.class);
    private final Vertx vertx;
    public static String EB_ADDRESS = AsyncTestEx02.class.getName();
    private final Random random = new Random();
    private static final String ATTR_NUMBER = "number";
    private static final String ATTR_REPLY = "reply";

    public AsyncTestEx02(Vertx vertx) {
        this.vertx = vertx;
    }
    ...
    public static void main(String[] args) {
        ...
        vertx.deployVerticle(new AsyncTestEx02(vertx), dr -> {
            try {

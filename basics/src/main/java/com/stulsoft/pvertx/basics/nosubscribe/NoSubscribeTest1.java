 ...
 * @author Yuriy Stul
 */
public class NoSubscribeTest1 {
    private static final Logger logger = LoggerFactory.getLogger(NoSubscribeTest1.class);

    public static void main(String[] args) {
        logger.info("==>main");
        var noSubscribeTest1 = new NoSubscribeTest1();

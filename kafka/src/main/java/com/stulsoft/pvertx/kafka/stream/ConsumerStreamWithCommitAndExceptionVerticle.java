...
/**
 * Vertx Kafka consumer with pause, resume, and commit.
 * Guarantees sequential processing.
 * Throws Exception and exits after 3rd message.
 *
 * @author Yuriy Stul
 */
public class ConsumerStreamWithCommitAndExceptionVerticle extends AbstractVerticle {
    private static final Logger logger = LoggerFactory.getLogger(ConsumerStreamWithCommitAndExceptionVerticle.class);

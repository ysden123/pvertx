 ...
 * @author Yuriy Stul
 */
public class EBServiceVerticle2 extends AbstractVerticle {
    private static final Logger logger = LoggerFactory.getLogger(EBServiceVerticle2.class);

    public static String EB_ADDRESS_1 = EBServiceVerticle2.class.getName() + ".1";
    public static String EB_ADDRESS_2 = EBServiceVerticle2.class.getName() + ".2";
    public static String EB_ADDRESS_3 = EBServiceVerticle2.class.getName() + ".3";
    public static String EB_ADDRESS_4 = EBServiceVerticle2.class.getName() + ".4";

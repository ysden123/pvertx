 ...
 * @author Yuriy Stul
 */
public class ServiceWithErrHandlingVerticle extends AbstractVerticle {
    private static final Logger logger = LoggerFactory.getLogger(ServiceWithErrHandlingVerticle.class);

    private static final String EB_ADDRESS = ServiceWithErrHandlingVerticle.class.getName();
    ...
    public static void main(String[] args) {
        ...
        Utils
                .deployVerticles(vertx, new String[]{ServiceWithErrHandlingVerticle.class.getName()})
